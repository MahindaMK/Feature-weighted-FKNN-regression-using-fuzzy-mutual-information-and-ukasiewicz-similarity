...
Reference: [Kumbure, M. M., Luukka, P., Collan, M.: eature-weighted FKNN regression using fuzzy mutual information and Łukasiewicz similarity. In: Proceeding of the IEEE International Conference on Fuzzy Systems (FUZZ-IEEE-2026)]
